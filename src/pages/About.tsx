      ...
      <section className="py-24 container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">Founded on the principles of engineering brilliance and uncompromising quality, RGS Constructor has grown into a global leader in commercial and industrial construction.</p>
            <p className="text-muted-foreground text-lg leading-relaxed">With over two decades of experience, our footprint can be seen in some of the most iconic infrastructure projects worldwide.</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative h-[500px]">
             <img src="https://images.unsplash.com/photo-1504307651254-35680f356f27?auto=format&fit=crop&q=80" alt="Construction site" className="w-full h-full object-cover grayscale border border-border" />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-background p-8 border border-border/50 hover:border-primary/50 transition-colors">
