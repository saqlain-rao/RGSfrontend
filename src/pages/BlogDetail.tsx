    ...
    <div className="bg-black min-h-screen text-white pt-24 pb-32">
      ...
      <section className="relative h-[60vh] min-h-[500px] w-full flex items-end pb-20">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-4xl">
          <Link to="/blog" className="inline-flex items-center gap-2 text-primary hover:text-white uppercase tracking-widest text-sm font-bold mb-8 transition-colors">
          ...
          <motion.div 
            ...
            className="flex flex-wrap items-center gap-6 text-sm text-gray-400 uppercase tracking-widest"
          >
      ...
      <section className="container mx-auto px-6 max-w-4xl relative z-20 mt-10">
        <motion.div 
          ...
          className="bg-zinc-950 border border-white/5 p-8 md:p-12 lg:p-16"
        >
          {/* Excerpt */}
          <div className="text-xl md:text-2xl text-gray-300 font-light leading-relaxed mb-12 pb-12 border-b border-white/10">
            {blog.excerpt}
          </div>
          
          {/* Main Content (HTML) */}
          <div 
            className="prose prose-invert prose-lg max-w-none prose-headings:uppercase prose-headings:tracking-tight prose-a:text-primary prose-p:text-gray-400 prose-img:rounded-xl prose-img:border prose-img:border-white/10"
          ...
          <div className="mt-20 pt-10 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-6">
            <div className="flex gap-3">
              {blog.tags?.map(tag => (
                <span key={tag} className="text-gray-500 text-xs font-bold uppercase tracking-widest border border-white/10 px-4 py-2 rounded-full">
                  #{tag}
                </span>
              ))}
            </div>
